...
namespace PCBS.UserControls
{
    public class CommandGroup: UserControl
    {
        ...
        #region UI
        protected static Label CreateLabel(string text, int y, int w) => new Label()
        {
        ...
        protected static CheckBox CreateCheckBox(string text, string tag, int y, int w) => new CheckBox()
        {
            Location = new Point(3, y),
            Size = new Size(w, 17),
            Tag = tag,
        ...
        protected static NumericUpDown CreateNumberBox(string tag, int x, int y, int w)
        {
        ...
        protected static ComboBox CreateComboBox(string tag, int x, int y, int w, params object[] items)
        {
